...
<!-- 3. Multiply numerator and denominator with \frac{1}{\sigma_{x_1}^2\sigma_{x_2}^2} -->

<!-- \begin{align} -->
<!-- c'(X'X)^{-1}c &= \left[ \frac{\sigma_{x_1}^2 + \sigma_{x_2}^2}{\sigma_{x_1}^2\sigma_{x_2}^2} + \frac{2\sigma_{x_1x_2}}{\sigma_{x_1}^2\sigma_{x_2}^2} \right] \bigg/ \left[ -->
<!-- \frac{\sigma_{x_1}^2\sigma_{x_2}^2}{\sigma_{x_1}^2\sigma_{x_2}^2} - \frac{\sigma_{x_1x_2}^2}{\sigma_{x_1}^2\sigma_{x_2}^2} \right] \\ -->

<!-- &= \left[ \frac{\sigma_{x_1}^2 + \sigma_{x_2}^2}{\sigma_{x_1}^2\sigma_{x_2}^2} + \frac{2}{\sigma_{x_1}\sigma_{x_2}}\rho \right] \bigg/ (1-\rho^2) \\ -->

<!-- &= \frac{\frac{\sigma_{x_1}^2 + \sigma_{x_2}^2}{\sigma_{x_1}^2\sigma_{x_2}^2} }{(1-\rho^2)} + \frac{2}{\sigma_{x_1}\sigma_{x_2}}\frac{\rho}{1-\rho^2} -->
<!-- \end{align} -->

<!-- The first component is increasing with an increasing value of $\rho$ only if the numerator is smaller than 1, which is necessarily true because $\sigma_{x_1}^2>1$ and $\sigma_{x_2}^2>1$ -->
